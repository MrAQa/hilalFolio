  ...
  const removeCoinFromCart = (coinToRemove) => {
    ...
    if (cartItems) {
      ...
      const updatedCartItems = cartItems?.filter(
        (item) => item._id !== coinToRemove._id
      );
          ...
          <div className="2xl:max-w-2xl xl:max-w-xl lg:max-w-lg md:max-w-md mx-auto px-3 lg:px-0">
            <div className="flex flex-col lg:flex-row gap-8">
              <div className="flex-1 rounded-2xl px-4 sm:px-8 py-8 bg-white min-h-[550px]">
                ...
                <div className="mt-8 flex flex-wrap gap-4 overflow-auto payment-container">
                  <div className="flex justify-between items-center max-h-16 gap-1 border-[2px] border-primaryPurple shadow-custom rounded-xl p-6 col-3-items">
                    ...
                    {
                      <div
                        className={`rounded-full size-6 border-[1px] border-lightThemeOutline flex items-center justify-center ${
                          true ? "bg-primaryPurple" : ""
                        }`}
                      >
                        {true && <TickIconWhite />}
                      </div>
              ...
              <div className="inset-y-0 rounded-2xl max-h-[874px] round w-full max-w-[430px] overflow-y-auto bg-white px-6 py-6">
                ...
                <div className="pb-6 mt-6 border-b-[1px] overflow-y-auto max-h-[274px] border-lightThemeOutline space-y-4">
                  {cartItem?.map((item, index) => (
                    ...
                    >
                      ...
                      <div
                        onClick={() => removeCoinFromCart(item)}
                        className="bg-[#FFE5E5] rounded-lg flex justify-center items-center min-h-[75px] w-[70px] cursor-pointer"
                      >
                        <DeleteIcon />
                      </div>
                    </div>
