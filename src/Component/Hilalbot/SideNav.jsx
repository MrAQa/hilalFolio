    ...
    return (
      <>
        ...
        <aside
          ...
          } fixed top-0 md:top-[100px] lg:top-[166px] left-0 md:left-6  z-40 w-[268px] h-full transition-transform md:translate-x-0`}
          aria-label="Sidebar"
        >
          <div className="h-full px-4 py-4 pt-0 overflow-y-auto bg-white side-nav rounded-tr-xl rounded-br-xl text-whiteGrey relative flex flex-col style-3">
            ...
            <div className="mt-4 text-lightSecondaryText text-base overflow-y-auto font-normal h-full min-h-[98px] style-3">
              ...
              {questions.length == 0 && (
                <div className="text-base font-medium text-center h-full flex items-center justify-center">
                  No Recenet Chats
                </div>
              )}
            </div>
