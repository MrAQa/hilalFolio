    ...
    return (
        <div className="container mx-auto px-4 pb-8">
          ...
          <div className="flex justify-end space-x-[48px] mt-8">
            ...
            {(!userData?.subscriptionPlanName  && !userData.subscription) &&   <button onClick={(e) => handlePaymentIntent(e, plan.productId)} className="bg-primaryPurple w-[253px] text-white font-semibold py-3 px-[18px] rounded-lg">
              { 'Subscribe'}
            </button>}
