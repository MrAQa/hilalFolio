    ...
    {({ open }) => (
      <>
        <div className="relative">
          <Listbox.Button
            className="relative min-w-40 rounded-lg bg-[#F2F2F2] border  shadow-sm px-6  pr-10 py-2 text-left cursor-default sm:text-base"
          >
            <span className="block truncate text-primaryDark font-semibold ">{ value==='All' ? placeholder :value}</span>
